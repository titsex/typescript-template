...
class Logger {
	private static errorLogPrefix = `[${COLORS.RED + FONT_WEIGHT.BOLD}ERROR${COLORS.NONE + FONT_WEIGHT.NONE}]`
	private static infoLogPrefix = `[${COLORS.CYAN + FONT_WEIGHT.BOLD}INFO${COLORS.NONE + FONT_WEIGHT.NONE}]`
